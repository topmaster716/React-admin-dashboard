...
var Loader = /** @class */ (function () {
    function Loader(options) {
        ...
        this.pool = __spread(Array(this.size)).map(function (x) { return new worker_1.WorkerThread({ taskConccurency: 100 }); });
    ...
    Loader.prototype.initialize = function () {
        ...
        return (this.initializing = Promise.all(this.pool.map(function (x) {
    ...
    Loader.prototype.loadEntry = function (wd, request, files) {
        if (files === void 0) { files = {}; }
        var mainFile = file_1.ensureDottedRelative(wd, path_1.resolve(wd, request));
        return this.load(wd, mainFile, files).then(function (entry) {
            return { entry: entry, files: files };
        }, function (e) {
            throw e;
        });
    };
    Loader.prototype.load = function (cd, request, files) {
        if (files === void 0) { files = {}; }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(Object.keys(file.deps).map(function (req) {
                                ...
                                return _this.load(fileDir, req, files).then(function (dep) {
                                    file.deps[req] = dep;
