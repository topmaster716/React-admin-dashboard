...
var nodeResolve = createResolver(), asyncNodeResolve = createResolver(false), moduleGlob = ['**/*', '!node_modules', '!test'], identity = function (x) { return x; }, defaultOptions = { loadContent: true, expand: false };
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, globby(file.package.files || moduleGlob, { cwd: pkgDir_1 })];
                case 4:
                    files = _c.sent();
                    files
