...
var FixedDataTableScrollHelper =
/*#__PURE__*/
function () {
  ...
  rowHeightGetter) {
    ...
    var
    /*?function*/
    subRowHeightGetter = arguments.length > 5 ? arguments[5] : undefined;

    _classCallCheck(this, FixedDataTableScrollHelper);

    var defaultFullRowHeight = defaultRowHeight + defaultSubRowHeight;
    this._rowOffsets = _PrefixIntervalTree["default"].uniform(rowCount, defaultFullRowHeight);
  ...
  _createClass(FixedDataTableScrollHelper, [{
    ...
    /*object*/
    {
      ...
      firstRow = (0, _clamp["default"])(firstRow, 0, Math.max(this._rowCount - 1, 0));
      ...
      position = (0, _clamp["default"])(position, 0, maxPosition);
      this._position = position;

      var firstRowIndex = this._rowOffsets.greatestLowerBound(position);

      firstRowIndex = (0, _clamp["default"])(firstRowIndex, 0, Math.max(this._rowCount - 1, 0));
    ...
    /*object*/
    {
      rowIndex = (0, _clamp["default"])(rowIndex, 0, Math.max(this._rowCount - 1, 0));
      offset = (0, _clamp["default"])(offset, -this._storedHeights[rowIndex], 0);
...
var _default = FixedDataTableScrollHelper;
