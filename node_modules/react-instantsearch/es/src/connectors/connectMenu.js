...
import { getIndex, cleanUpValue, refineValue, getCurrentRefinementValue, getResults } from '../core/indexUtils';
...
function getCurrentRefinement(props, searchState, context) {
  return getCurrentRefinementValue(props, searchState, context, namespace + '.' + getId(props), null, function (currentRefinement) {
...
export default createConnector({
  ...
  getProvidedProps: function getProvidedProps(props, searchState, searchResults, meta, searchForFacetValuesResults) {
    ...
    var sortedItems = withSearchBox && !isFromSearch ? _orderBy(items, ['isRefined', 'count', 'label'], ['desc', 'desc', 'asc']) : items;
