...
export function cleanUpValue(searchState, context, id) {
  ...
  if (hasMultipleIndex(context) && Boolean(searchState.indices)) {
    return namespace ? _extends({}, searchState, {
      indices: _extends({}, searchState.indices, _defineProperty({}, index, _extends({}, searchState.indices[index], _defineProperty({}, namespace, _omit(searchState.indices[index][namespace], '' + attributeName)))))
    }) : _omit(searchState, 'indices.' + index + '.' + id);
  } else {
    return namespace ? _extends({}, searchState, _defineProperty({}, namespace, _omit(searchState[namespace], '' + attributeName))) : _omit(searchState, '' + id);
  }
}