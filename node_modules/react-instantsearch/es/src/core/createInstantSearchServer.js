...
var _name$version$descrip = {
  ...
  devDependencies: {
    ...
    version = _name$version$descrip.version;
...
var createInstantSearch = function createInstantSearch(algoliasearch) {
  var InstantSearch = cis(algoliasearch, {
    Root: 'div',
  ...
  var findResultsState = function findResultsState(App, props) {
    searchParameters = [];
    ReactDom.renderToString(React.createElement(App, props));
    ...
    }, new SearchParameters(_extends({ index: indexName }, highlightTags)));
