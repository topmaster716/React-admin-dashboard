...
export default function createInstantSearchManager(_ref) {
  ...
  var baseSP = new SearchParameters(_extends({}, searchParameters, {
    index: indexName
  }, highlightTags));

  var stalledSearchTimer = null;

  var helper = algoliasearchHelper(algoliaClient, indexName, baseSP);
  ...
  function handleSearchSuccess(content) {
    ...
    results = !_isEmpty(derivedHelpers) && results.getFacetByName ? {} : results;

    if (!_isEmpty(derivedHelpers)) {
    ...
    var nextState = _omit(_extends({}, currentState, {
      results: results,
  ...
  function handleNewSearch() {
    if (!stalledSearchTimer) {
      stalledSearchTimer = setTimeout(function () {
        var nextState = _omit(_extends({}, store.getState(), {
          isSearchStalled: true
        }), 'resultsFacetValues');
        store.setState(nextState);
      }, stalledSearchDelay);
