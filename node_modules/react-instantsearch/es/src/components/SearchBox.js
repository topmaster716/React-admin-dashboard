...
var DefaultReset = function DefaultReset() {
  return React.createElement(
    ...
    React.createElement('use', { xlinkHref: '#sbx-icon-clear-3' })
  );
};
...
var DefaultSubmit = function DefaultSubmit() {
  return React.createElement(
    'svg',
    { role: 'img', width: '1em', height: '1em' },
    React.createElement('use', { xlinkHref: '#sbx-icon-search-13' })
  );
};
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          this.props.showLoadingIndicator && React.createElement(
            'div',
...
SearchBox.defaultProps = {
  ...
  loadingIndicatorComponent: React.createElement(DefaultLoadingIndicator, null),
  submitComponent: React.createElement(DefaultSubmit, null),
  resetComponent: React.createElement(DefaultReset, null)
};
